...
use App\Livewire\Project\Service\ContainerInfo as ServiceContainerInfo;
...
use App\Livewire\Project\Service\Network as ServiceNetwork;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('project/{project_uuid}/environment/{environment_uuid}/service/{service_uuid}')->group(function () {
        ...
        Route::get('/{stack_service_uuid}/container-info', ServiceContainerInfo::class)->name('project.service.container-info');
        Route::get('/{stack_service_uuid}/network', ServiceNetwork::class)->name('project.service.network');
